...
import { IRegion } from 'app/shared/model/resource/region.model';
// tslint:disable-next-line:no-unused-variable
    ...
    return (
      <div>
        <h2 id="region-heading">
          <Translate contentKey="gatewayApp.resourceRegion.home.title">Regions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.resourceRegion.home.createLabel">Create new Region</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="gatewayApp.resourceRegion.regionName">Region Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
