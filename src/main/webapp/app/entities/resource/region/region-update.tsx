    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="gatewayApp.resourceRegion.home.createOrEditLabel">
              <Translate contentKey="gatewayApp.resourceRegion.home.createOrEditLabel">Create or edit a Region</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
